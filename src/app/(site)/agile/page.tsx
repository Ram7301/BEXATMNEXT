...
const Agile: React.FC = () => {
    ...
    const loadFeatures = async () => {
      try {
        const res = await fetch(
          "https://bexatm.com/ContentManageSys.php?contentId=CON1009"
        );
        const data = await res.json();
        console.log(data, "agile"); // Check API response
  ...
  return (
    <>
      <Head>
        <title>Agile Project Management | BexATM</title>
        <meta
          name="description"
        ...
        <link rel="canonical" href="https://bexatm.com/agile" />
      </Head>
          ...
          <div className="bg-black/70 rounded-2xl px-6 py-6 relative">
            <h2 className="text-4xl lg:text-5xl font-medium text-white tracking-tight leading-tight">
              ...
              {user?.isAdmin ? (
                ...
                <button
                  onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100143&contentType=T")}
            ...
            <p className="mt-2 max-w-4xl mx-auto text-md text-gray-200 leading-relaxed">
              ...
              {user?.isAdmin ? (
                ...
                <button
                  onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100144&contentType=T")}
                  className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                  title="Edit Section"
                >
                  <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100101&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100102&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-base leading-snug whitespace-pre-line">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100103&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100107&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100108&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-base leading-snug whitespace-pre-line">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100109&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100113&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100114&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-base leading-snug whitespace-pre-line">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100115&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100119&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100120&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-base leading-snug whitespace-pre-line">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100121&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100125&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100126&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-base leading-snug whitespace-pre-line">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100127&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100131&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100132&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <ul
                className={`text-lg leading-[1.6] space-y-2 ${features.CON100133 ? "list-disc pl-6 text-dark/50 dark:text-white/50" : "list-none pl-0 text-dark/50 dark:text-white/50"}`}
              >
                {features.CON100133 && features.CON100133.map((desc, index) => (
                  <li key={index}>{desc}</li>
                ))}
                {user?.isAdmin ? (

                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100133&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100137&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100138&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-base leading-snug whitespace-pre-line">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1009&contentTextID=CON100139&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
