...
const Managerdesk: React.FC = () => {
    ...
    const data: Feature[] = [
      {
        ...
        description:
          "The Approval screen allows managers to review, approve, or reject various employee requests, including leave, overtime, expenses, and task completions.",
     ...
     
      {
        ...
        description:
          "Spot Activity captures real-time events or actions that occur spontaneously. It helps in tracking immediate issues or tasks requiring urgent attention.",
  ...
  description:
    "The Time Sheet module allows employees to record daily work hours, assigned tasks, and project contributions, enabling accurate payroll and productivity tracking.",
  ...
  icon: "mdi:clock-time-eight",
      ...
      //   subtitle: "Manual Attendance Management",
      //   description:
      //     "Managers can manually enter or correct attendance data when necessary, ensuring payroll and reporting accuracy.",
      //   image: "/images/Attendance.png",
      //   href: "#attendanceentry",
      //   badge: "Attendance",
      //   reverse: true,
      ...
      //   subtitle: "Comprehensive Attendance Logs",
      //   description:
      //     "Provides a comprehensive overview of attendance logs for all employees, supporting audits and daily team tracking.",
      //   image: "/images/attendanceregister.png",
      //   href: "#attendanceregister",
      //   badge: "Attendance",
      //   reverse: false,
      ...
      <div className="relative text-center mb-16 mt-12 bg-[url('/images/background.png')] bg-cover bg-center bg-no-repeat rounded-2xl shadow-lg">
        <div className="bg-black/50 rounded-2xl px-6 py-16">
          ...
          <p className="mt-4 max-w-4xl mx-auto text-lg text-gray-200">
            A Manager Approval Screen is used by managers to review, approve, or
            reject requests made by their team members. This may include leave
            applications, on-duty requests, shift changes, timesheet approvals,
