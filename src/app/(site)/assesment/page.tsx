...
const Assessment: React.FC = () => {
    ...
    const loadFeatures = async () => {
      try {
        const res = await fetch(
          "https://bexatm.com/ContentManageSys.php?contentId=CON1008"
        );
  ...
  return (
    <>
      <Head>
        <title>AssessMent System | BexATM</title>
        <meta
          name="description"
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ContactPage",
              "url": "https://bexatm.com/assesment",
        ...
        <link rel="canonical" href="https://bexatm.com/assesment" />
      </Head>
          ...
          <div className="bg-black/70 rounded-2xl px-6 py-6 relative">
            <h2 className="text-4xl lg:text-5xl font-medium text-white tracking-tight leading-tight">
              ...
              {user?.isAdmin ? (
                ...
                <button
                  onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100131&contentType=T")}
            ...
            <p className="mt-2 max-w-4xl mx-auto text-md text-gray-200 leading-relaxed">
              ...
              {user?.isAdmin ? (
                ...
                <button
                  onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100132&contentType=T")}
                  className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                  title="Edit Section"
                >
                  <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100101&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100102&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-lg leading-[1.3]">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100103&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100107&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100108&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-lg leading-[1.3]">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100109&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100113&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100114&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100119&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100120&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-lg leading-[1.3]">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100121&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
                ...
                >
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    {user?.isAdmin ? (
                      ...
                      <button
                        onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100123&contentType=T")}
                        className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                        title="Edit Section"
                      >
                        <svg
            ...
            <div className="lg:w-1/2">
              <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100125&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <h2 className="lg:text-3xl text-2xl mt-2 mb-2 font-medium leading-[1.2] text-dark dark:text-white">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100126&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
              ...
              <p className="text-dark/50 dark:text-white/50 text-lg leading-[1.3]">
                ...
                {user?.isAdmin ? (
                  ...
                  <button
                    onClick={() => router.push("/content/cms?contentID=CON1008&contentTextID=CON100127&contentType=T")}
                    className="bg-primary text-white p-1 rounded-full shadow-lg hover:bg-opacity-80 transition"
                    title="Edit Section"
                  >
                    <svg
