    ...
    <main className="min-h-screen bg-white text-gray-800">
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          {/* FAQ (unchanged) */}
          <div>
            <h2 className="text-2xl md:text-3xl font-bold mb-8 text-black-800">Got Questions?</h2>
            <div className="space-y-3">
              {["Is it secure?", "Works for remote teams?", "Does it support multiple buildings?"].map((q, i) => (
                <div key={i} className="border bg-white p-2 rounded-md shadow-sm">
                  <button
                  ...
                  {openIndex === i && <p className="text-sm pt-2">Yes, fully cloud secure.</p>}
                </div>
              ))}
            </div>
          </div>
